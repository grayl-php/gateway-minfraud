...
class MinFraudOmnipayHelper
{
     ...
     */
    public function translateOmnipayResponseController(
        MinFraudInsightsRequestData $request_data,
        OmnipayResponseControllerAbstract $gateway_response
    ): void {
