<?php
    ...
    */
   class MinFraudInsightsResponseService implements ResponseServiceInterface
   {
       ...
       * @return float
       */
      public function getRiskScore ( MinFraudInsightsResponseData $response_data ): ?float
      {
       ...
       * @return string
       */
      public function getDisposition ( MinFraudInsightsResponseData $response_data ): ?string
      {
       ...
       * @return bool
       */
      private function isDispositionSuccessful ( MinFraudInsightsResponseData $response_data ): bool
      {
       ...
       * @return Warning[]
       */
      private function getWarnings ( MinFraudInsightsResponseData $response_data ): ?array
      {
