 ...
 */
class MinFraudInsightsRequestData extends
    RequestDataAbstract
{
     ...
     */
    public function setDeviceParam(
        string $key,
        ?string $value
    ): void {

        // Set the parameter
        $this->device_params->setVariable(
            $key,
            $value
        );
    }
     ...
     * @param ?string $value The value for the parameter
     */
    public function setEventParam(
        string $key,
        ?string $value
    ): void {

        // Set the parameter
        $this->event_params->setVariable(
            $key,
            $value
        );
    }
    ...
    public function setAccountParam(
        ...
        // Set the parameter
        $this->account_params->setVariable(
            $key,
            $value
        );
    }
     ...
     * @param ?string $value The value for the parameter
     */
    public function setBillingParam(
        string $key,
        ?string $value
    ): void {

        // Set the parameter
        $this->billing_params->setVariable(
            $key,
            $value
        );
    }
     ...
     * @param ?string $value The value for the parameter
     */
    public function setShippingParam(
        string $key,
        ?string $value
    ): void {

        // Set the parameter
        $this->shipping_params->setVariable(
            $key,
            $value
        );
    }
     ...
     * @param ?string $value The value for the parameter
     */
    public function setPaymentParam(
        string $key,
        ?string $value
    ): void {

        // Set the parameter
        $this->payment_params->setVariable(
            $key,
            $value
        );
    }
     ...
     * @param ?string $value The value for the parameter
     */
    public function setCreditCardParam(
        string $key,
        ?string $value
    ): void {

        // Set the parameter
        $this->credit_card_params->setVariable(
            $key,
            $value
        );
    }
     ...
     * @param ?string $value The value for the parameter
     */
    public function setOrderParam(
        string $key,
        ?string $value
    ) {

        // Set the parameter
        $this->order_params->setVariable(
            $key,
            $value
        );
    }
     ...
     * @param ?string $value The value for the parameter
     */
    public function setCustomParam(
        string $key,
        ?string $value
    ): void {

        // Set the parameter
        $this->custom_params->setVariable(
            $key,
            $value
        );
    }
