 ...
 */
class MinFraudInsightsRequestControllerTest extends
    TestCase
{
     ...
     * @throws \Exception
     */
    public function testCreateMinFraudInsightsRequestController(
        ...
        // Check the type of object returned
        $this->assertInstanceOf(
            MinFraudInsightsRequestController::class,
            $request_controller
        );
     ...
     * @throws \Exception
     */
    public function testSendMinFraudInsightsRequestController(
        MinFraudInsightsRequestController $request
    ): MinFraudInsightsResponseController {
        ...
        // Check the type of object returned
        $this->assertInstanceOf(
            MinFraudInsightsResponseController::class,
            $response
        );
     ...
     */
    public function testMinFraudInsightsResponseController(
     ...
     * @throws \Exception
     */
    public function testMinFraudOrderPaymentHelper(
        OrderController $order,
        MinFraudInsightsResponseController $response
    ): void {
        ...
        MinFraudOrderHelper::getInstance()
            ->newOrderPaymentFromMinFraudResponseController(
                $order,
                $response,
